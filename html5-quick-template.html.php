 ...
 * Sources at <http://github.com/e-picas/html5-quick-template>
 * Copyright (c) 2014-2015 Pierre Cassat <http://picas.fr/>
 * 
 ...
 * @prefix      hqt_|HQT_
 * @license     Apache 2.0
 * @sources     http://github.com/e-picas/html5-quick-template
 * @author      picas (me at picas dot fr)
 */
 ...
 */
if (!isset($stamp_url)) $stamp_url = 'http://github.com/e-picas/html5-quick-template';
...
$hqt_default_settings = array(
    ...
    'app_infos' => function() { return array(
            ...
            'maintainer' => '<a href="http://picas.fr/" title="See online">@picas</a>',
 ...
 */
define('HQT_VERSION', '1.2.9-dev');

/**
 * @constant    URL of the app repo
 */
define('HQT_HOME', 'http://github.com/e-picas/html5-quick-template');
    ...
    <?php foreach ($menu as $menu_item) : ?>
        <?php if (isset($menu_item['items']) && !empty($menu_item['items'])) : ?>
            ...
            <?php foreach ($menu_item['items'] as $menu_sub_item) : ?>
                <?php if (isset($menu_sub_item['type']) && in_array($menu_sub_item['items'], array('divider', 'separator'))) : ?>
                            <li class="divider"></li>
                <?php elseif (isset($menu_sub_item['type']) && $menu_sub_item['type']=='header') : ?>
                            <li class="dropdown-header"><a href="<?php if (isset($menu_sub_item['url'])) echo $menu_sub_item['url']; ?>" title="<?php if (isset($menu_sub_item['title'])) echo hqt_translate($menu_sub_item['title']); ?>"><?php if (isset($menu_item['content'])) echo hqt_translate($menu_sub_item['content']); ?></a></li>
                <?php else: ?>
